"""
Passive Aggressive Classifier  SKLEARN:

High results

https://scikit-learn.org/dev/modules/generated/sklearn.linear_model.PassiveAggressiveClassifier.html 
...
# Load dataset
data = pd.read_csv(cwd + '\models paper\comments.csv', encoding='latin-1')
...
final_predictions = model.predict(X_test_vectorized)
